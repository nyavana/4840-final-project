...
\begin{center}
  ...
  \end{tabular}\\[1.0em]
  {\small Describes the repository as of commit \texttt{a6eb347} on \texttt{origin/main}
...
\begin{tikzpicture}[
  >=Stealth,
  hps/.style   ={draw, rounded corners=3pt, minimum height=1.8cm,
                 minimum width=3.6cm, align=center, font=\small\sffamily,
                 fill=blue!10},
  periph/.style={draw, rounded corners=3pt, minimum height=1.8cm,
                 minimum width=3.6cm, align=center, font=\small\sffamily,
                 fill=orange!15},
  ext/.style   ={draw, rounded corners=3pt, minimum height=1.2cm,
  ...
  \node[font=\scriptsize\sffamily, color=blue!60]   at (hps.south)    [below=14pt] {(HPS side)};
  \node[font=\scriptsize\sffamily, color=orange!70] at (periph.south) [below=14pt] {(FPGA side)};
...
\begin{tikzpicture}[
  >=Stealth,
  mem/.style={draw, rounded corners=2pt, minimum height=1.4cm,
              minimum width=3.2cm, align=center, font=\small\sffamily,
              fill=purple!10},
  logic/.style={draw, rounded corners=2pt, minimum height=1.4cm,
                minimum width=3.2cm, align=center, font=\small\sffamily,
                fill=orange!15},
  io/.style={draw, rounded corners=2pt, minimum height=1.2cm,
             minimum width=2.4cm, align=center, font=\small\sffamily,
             fill=blue!10},
  bus/.style={->, thick},
  cidx/.style={circle, draw, thick, fill=white, inner sep=0pt,
               minimum size=13pt,
  ...
  \begin{scope}[on background layer]
    \node[draw=orange!50, dashed, rounded corners=4pt,
          fit=(av)(st)(bg)(sr)(vc)(rend)(lb)(pal)(vga),
          inner sep=12pt,
          label={[font=\small\sffamily\bfseries, orange!70]above:%
                 \texttt{pvz\_top} (inside the FPGA fabric)}] {};
  \end{scope}
\end{tikzpicture}%
}
\caption{Inside \texttt{pvz\_top}. Memories are shaded purple, combinational
  logic and FSMs orange, Avalon-facing I/O blue. Each arrow is
...
\toprule
\textbf{\#} & \textbf{From} & \textbf{To} & \textbf{Signals (width)}\\
\midrule
...
\begin{tabular}{c l l}
\toprule
\textbf{Indices} & \textbf{Slot} & \textbf{Role} \\
\midrule
...
\begin{tikzpicture}[
  ...
  mem/.style={blk, fill=purple!10},
  logic/.style={blk, fill=orange!15},
  ext/.style={blk, fill=green!10},
  writebus/.style={->, thick, color=BlueViolet},
  readbus/.style={->, thick, color=ForestGreen},
  swap/.style={<->, thick, dashed, color=red},
  ...
  \node[font=\scriptsize\sffamily, align=left, fill=gray!5, draw=gray!30,
        rounded corners=2pt, inner sep=4pt]
       at (14.5, 2.0)
       {\textcolor{BlueViolet}{$\rightarrow$} renderer writing\\[1pt]
        \textcolor{ForestGreen}{$\rightarrow$} DAC reading\\[1pt]
        \textcolor{red}{$\leftrightarrow$} hsync swap};
\end{tikzpicture}%
}
\caption{Scanline dataflow. During scanline $N$, the DAC drains line
  buffer A (green path, reading 8-bit palette indices that
  ...
  on the violet write port. At \texttt{hcount}\,=\,0 the
...
\toprule
\textbf{Component} & \textbf{Actual (b)} & \textbf{Projected (b)} & \textbf{Notes} \\
\midrule
...
\toprule
\textbf{Offset} & \textbf{Name} & \textbf{R/W}
  & \textbf{Write causes} & \textbf{Read returns} & \textbf{Latency}\\
\midrule
...
\begin{lstlisting}[language=Verilog, numbers=none, basicstyle=\ttfamily\footnotesize]
shadow[cur_addr] <= {
...
\begin{tikzpicture}[
  >=Stealth,
  us/.style   ={draw, rounded corners=2pt, fill=blue!10,
                minimum width=6.2cm, minimum height=1.1cm,
                align=center, font=\small\sffamily},
  kern/.style ={draw, rounded corners=2pt, fill=orange!15,
                minimum width=6.2cm, minimum height=1.1cm,
                align=center, font=\small\sffamily},
  fabric/.style={draw, rounded corners=2pt, fill=purple!12,
                minimum width=6.2cm, minimum height=1.1cm,
                align=center, font=\small\sffamily},
  ...
  \node[font=\footnotesize\sffamily\bfseries, color=blue!60,
        anchor=east] at (-3.5, 3.0) {User space};
  \node[font=\footnotesize\sffamily\bfseries, color=orange!70,
        anchor=east] at (-3.5,-2.0) {Kernel};
  \node[font=\footnotesize\sffamily\bfseries, color=purple!60,
...
\begin{tikzpicture}[
  ...
  \node[anchor=south]
    ...
    {\small 640 pixels};
  \node[anchor=south, font=\scriptsize\sffamily, text=gray]
