...
**Worktree:** `/homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine` (branch `audio-engine`, off `v3-controller-and-roster`). Already exists, spec committed at HEAD.
...
- [ ] **Confirm worktree state.** Run:
  ```bash
  git -C /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine status --short
  git -C /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine log --oneline -2
  ```
...
- [ ] **Step 2: Verify it fails** (module not defined).
  ...
  Run from `hw/`:
  ```bash
  cd /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/hw
...
- [ ] **Step 1: Read the file first** to find the existing port list and instance of the Qsys system:
  ...
  ```bash
  grep -n "AUD_\|FPGA_I2C_\|soc_system soc" /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/hw/soc_system_top.sv | head -20
  ```
...
- [ ] **Step 2: Cross-compile sanity check** (skip if no ARM toolchain; log gap in `doc/v4-known-issues.md`):
  ...
  ```bash
  cd /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/sw
...
- [ ] **Step 1: Read the existing `sw/pvz.h`** to see what's already there:
  ...
  ```bash
  grep -n "typedef\|enum\|#define" /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/sw/pvz.h
  ```
...
- [ ] **Step 1: Read `sw/game.h`** to find the current `game_step` declaration:
  ...
  ```bash
  grep -n "game_step" /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/sw/game.h
  ```
...
```
  ...
  ```bash
  grep -n "game_step" /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/sw/main.c \
                     /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/sw/test/test_game.c
  ```
...
- [ ] **Step 1: Inspect `main.c`** to find the main loop:
  ...
  ```bash
  grep -n "game_step\|STATE_PLAYING\|main.c" /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/sw/main.c | head -20
  ```
...
- [ ] **Step 2: Make it executable.**
  ...
  ```bash
  chmod +x /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/hw/audio/build_audio_mif.py
  ```
...
- [ ] **Step 1: Generate a placeholder tone-sweep WAV** using Python's stdlib (no external audio tools needed).
  ...
  with wave.open("/homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/hw/audio/assets/bgm_theme.wav", "wb") as w:
  ...
  Run:
  ```bash
  mkdir -p /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/hw/audio/assets
...
```markdown
**Audio (Scope A shipped via `audio-engine`):** A second Avalon-slave
...
- [ ] **Step 2: Rebuild the PDF** (if a Makefile target exists; otherwise skip):
  ...
  ```bash
  cd /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine/doc/design-document
...
This branch (`audio-engine`) adds a PCM audio engine to the project. v3 ships
...
- [ ] **Step 1: Final log review.**
  ...
  ```bash
  git -C /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine log --oneline -40
  ```
  Expected: the audio-engine branch has the full chain starting from
...
- [ ] **Step 2: Push.**
  ...
  ```bash
  git -C /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine push -u origin audio-engine
  ```

- [ ] **Step 3: Report the branch URL to the user.** The remote is
  `nyavana/pvz-fpga`; surface
  `https://github.com/nyavana/pvz-fpga/tree/audio-engine` (or whatever `gh
...
- [ ] **Step 3: If user wants the worktree removed after merge:**
  ...
  ```bash
  git -C /homes/user/stud/spring26/cy2822/4840-final/pvz-fpga worktree remove /homes/user/stud/spring26/cy2822/4840-final/worktrees/audio-engine
  ```
